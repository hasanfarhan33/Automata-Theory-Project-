...
public class Divide_And_Conquer extends Canvas {
	...
	public static void Divide_And_Conquer_Window()
	{
		
		 JFrame Main_Window = new JFrame("Divide and Conquer");
		 Canvas canvas = new Divide_And_Conquer();
	...
	public void paint(Graphics g)
    {
        ...
        for(int i = 0; i < X_Coordinates.size(); i++){  //This looks at all the x and y coordinates at the same time in both arraylists
            g.fillOval((Math.round(X_Coordinates.get(i)) % 1000),(Math.round(Y_Coordinates.get(i)) % 1000), 10, 10);
            
        }
    }
	
	public static void Divide_And_Conquer_Algorithm()
	{
